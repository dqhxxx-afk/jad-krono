...
export default function Footer({ t }) {
  ...
  return (
    <footer className="site-footer jk-footer-v211">
      <div className="footer-v211-main">
        <div className="footer-v211-brand">
        ...
        <nav className="footer-v211-social" aria-label="Contact links">
      ...
      <p className="footer-v211-disclaimer">
      ...
      <div className="footer-v211-bottom">
