...
export default function ContactPage() {
  ...
  return (
    <>
      <Header t={t} />
      <main className="page-shell contact-page-v29">
        <section className="contact-v29">
          <div className="contact-v29-copy">
          ...
          <div className="contact-v29-grid">
            <article className="contact-v29-card enquiry">
              <span>Enquiry</span>
              ...
              <div className="contact-v29-actions">
            ...
            <article className="contact-v29-card">
              <span>Visit</span>
              <h3>Singapore</h3>
            ...
            <article className="contact-v29-card follow">
              <span>Follow</span>
              <h3>JAD KRONO</h3>
        ...
        <section className="sourcing-v29-band">
          <div>
